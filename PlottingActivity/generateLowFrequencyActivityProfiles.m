function generateLowFrequencyActivityProfiles(duration)
...
%         fn = ['Early_s270TO90_Trace_' num2str(iTrace) '_ActivityProfile'];
%         saveas(gcf,fn,'fig')
%         close all
%         
%         figure(2)
...
%         mkdir(['Session' num2str(iDataset)])
%         cd (['Session' num2str(iDataset)])
%         fn = ['Middle_s270TO90_Trace_' num2str(iTrace) '_ActivityProfile'];
%         saveas(gcf,fn,'fig')
%         close all
%         
%         figure(3)
...
%         mkdir(['Session' num2str(iDataset)])
%         cd (['Session' num2str(iDataset)])
%         fn = ['Late_s270TO90_Trace_' num2str(iTrace) '_ActivityProfile'];
%         saveas(gcf,fn,'fig')
%         close all
...
%         mkdir(['Session' num2str(iDataset)])
%         cd (['Session' num2str(iDataset)])
%         fn = ['Early_s90TO270_Trace_' num2str(iTrace) '_ActivityProfile'];
%         saveas(gcf,fn,'fig')
%         close all
%         
%         figure(2)
...
%         mkdir(['Session' num2str(iDataset)])
%         cd (['Session' num2str(iDataset)])
%         fn = ['Middle_s90TO270_Trace_' num2str(iTrace) '_ActivityProfile'];
%         saveas(gcf,fn,'fig')
%         close all
%         
%         figure(3)
...
%         mkdir(['Session' num2str(iDataset)])
%         cd (['Session' num2str(iDataset)])
%         fn = ['Late_s90TO270_Trace_' num2str(iTrace) '_ActivityProfile'];
%         saveas(gcf,fn,'fig')
%         close all
...
[names{1:573}] = deal('Early Channels');
[names{574:574+573-1}] = deal('Middle Channels');
[names{1147:1147+573-1}] = deal('Late Channels');

colors(1:573) = ones(573,1);
colors(574:574+573-1) = 2.*ones(573,1);
colors(1147:1147+573-1) = 3.*ones(573,1);
