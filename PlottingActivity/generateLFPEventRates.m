...
datasetsLfpStats{1} = ['E:\H07\12-06-2016\PFC\Bfsgrad1\LFPStatistics\MMstd4_eventRateByTime_' num2str(duration) 'ms_Chebyshev1_' 'low' '.mat'];
datasetsLfpStats{2} = ['E:\H07\13-07-2016\PFC\Bfsgrad1\LFPStatistics\MMstd4_eventRateByTime_' num2str(duration) 'ms_Chebyshev1_' 'low' '.mat'];
datasetsLfpStats{3} = ['E:\H07\20161019\PFC\Bfsgrad1\LFPStatistics\MMstd4_eventRateByTime_' num2str(duration) 'ms_Chebyshev1_' 'low' '.mat'];
datasetsLfpStats{4} = ['E:\H07\20161025\PFC\Bfsgrad1\LFPStatistics\MMstd4_eventRateByTime_' num2str(duration) 'ms_Chebyshev1_' 'low' '.mat'];
datasetsLfpStats{5} = ['E:\A11\20170305\PFC\Bfsgrad1\LFPStatistics\MMstd4_eventRateByTime_' num2str(duration) 'ms_Chebyshev1_' 'low' '.mat'];
datasetsLfpStats{6} = ['E:\A11\20170302\PFC\Bfsgrad1\LFPStatistics\MMstd4_eventRateByTime_' num2str(duration) 'ms_Chebyshev1_' 'low' '.mat'];

datasets_parentDir{1} = ['E:\H07\12-06-2016\PFC\Bfsgrad1\'];
datasets_parentDir{2} = ['E:\H07\13-07-2016\PFC\Bfsgrad1\'];
datasets_parentDir{3} = ['E:\H07\20161019\PFC\Bfsgrad1\'];
datasets_parentDir{4} = ['E:\H07\20161025\PFC\Bfsgrad1\'];
datasets_parentDir{5} = ['E:\A11\20170305\PFC\Bfsgrad1\'];
datasets_parentDir{6} = ['E:\A11\20170302\PFC\Bfsgrad1\'];
...
% Plot pooled
low_pooled_eventRate_BR_270TO90 = (reshape(low_eventRate_BR_270TO90,4*96,length(t)));
low_pooled_eventRate_BR_90TO270 = (reshape(low_eventRate_BR_90TO270,4*96,length(t)));
low_pooled_eventRate_PA_270TO90 = (reshape(low_eventRate_PA_270TO90,4*96,length(t)));
low_pooled_eventRate_PA_90TO270 = (reshape(low_eventRate_PA_90TO270,4*96,length(t)));
...
% Plot pooled
beta_pooled_eventRate_BR_270TO90 = (reshape(beta_eventRate_BR_270TO90,4*96,length(t)));
beta_pooled_eventRate_BR_90TO270 = (reshape(beta_eventRate_BR_90TO270,4*96,length(t)));
beta_pooled_eventRate_PA_270TO90 = (reshape(beta_eventRate_PA_270TO90,4*96,length(t)));
beta_pooled_eventRate_PA_90TO270 = (reshape(beta_eventRate_PA_90TO270,4*96,length(t)));
