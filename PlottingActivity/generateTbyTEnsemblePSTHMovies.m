function generateTbyTEnsemblePSTHMovies
...
for iDataset = 1:length(datasets)
    ...
    for iSwitch = 1:length(sdf_br_s270TO90)
        ...
        v = VideoWriter(['TTL_AD_Sel_BR_s270TO90_Transition_' num2str(iSwitch) '.avi']);
        v.FrameRate = 5;
        open(v);
    ...
    for iSwitch = 1:length(sdf_br_s90TO270)
        ...
        v = VideoWriter(['TTL_AD_Sel_BR_s90TO270_Transition_' num2str(iSwitch) '.avi']);
        v.FrameRate = 5;
        open(v);
        figure('Renderer', 'painters', 'Position', [10 10 900 600])
    ...
    for iSwitch = 1:length(sdf_pa_s270TO90)
        ...
        v = VideoWriter(['TTL_AD_Sel_PA_s270TO90_Transition_' num2str(iSwitch) '.avi']);
        v.FrameRate = 5;
        open(v);
       figure('Renderer', 'painters', 'Position', [10 10 900 600])
    ...
    for iSwitch = 1:length(sdf_pa_s90TO270)
        ...
        v = VideoWriter(['TTL_AD_Sel_PA_s90TO270_Transition_' num2str(iSwitch) '.avi']);
        v.FrameRate = 5;
        open(v);
        figure('Renderer', 'painters', 'Position', [10 10 900 600])
