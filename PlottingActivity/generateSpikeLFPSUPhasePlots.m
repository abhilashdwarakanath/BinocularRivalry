function generateSpikeLFPSUPhasePlots(duration)
...
for iDataset = 1:nDatasets
    ...
    legend('P2NP','NP2P')
    suptitle(['Session #'  num2str(iDataset) ' ' 'SU Spike Phase Distributions'])
    cd(['B:\Results\SpikeLFPCoupling\PhaseDistribution\' ts 's'])
    fn = ['spikeLFPPhasePlot_allSpikes_Dataset_' num2str(iDataset) '_' num2str(duration) 'ms'];
    saveas(gcf,fn,'png');
    saveas(gcf,fn,'fig');
