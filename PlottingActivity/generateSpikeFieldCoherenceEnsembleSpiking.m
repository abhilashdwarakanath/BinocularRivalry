function generateSpikeFieldCoherenceEnsembleSpiking
...
for iBin = 1:4
    ...
    for iDataset = 1:length(datasets)
        ...
        post_BR_ga_dominant = [post_BR_ga_dominant; SFC(iBin).sfc_BR_sel90_270TO90_Post;SFC(iBin).sfc_BR_sel270_90TO270_Post];
        post_BR_ga_suppressed = [post_BR_ga_suppressed; SFC(iBin).sfc_BR_sel90_90TO270_Post;SFC(iBin).sfc_BR_sel270_270TO90_Post];
        pre_BR_ga_dominant = [pre_BR_ga_dominant; SFC(iBin).sfc_BR_sel90_90TO270_Pre;SFC(iBin).sfc_BR_sel270_270TO90_Pre];
        pre_BR_ga_suppressed = [pre_BR_ga_suppressed; SFC(iBin).sfc_BR_sel90_270TO90_Pre;SFC(iBin).sfc_BR_sel270_90TO270_Pre];
        
        post_PA_ga_dominant = [post_PA_ga_dominant; SFC(iBin).sfc_PA_sel90_270TO90_Post;SFC(iBin).sfc_PA_sel270_90TO270_Post];
        post_PA_ga_suppressed = [post_PA_ga_suppressed; SFC(iBin).sfc_PA_sel90_90TO270_Post;SFC(iBin).sfc_PA_sel270_270TO90_Post];
        pre_PA_ga_dominant = [pre_PA_ga_dominant; SFC(iBin).sfc_PA_sel90_90TO270_Pre;SFC(iBin).sfc_PA_sel270_270TO90_Pre];
        pre_PA_ga_suppressed = [pre_PA_ga_suppressed; SFC(iBin).sfc_PA_sel90_270TO90_Pre;SFC(iBin).sfc_PA_sel270_90TO270_Pre];
    ...
    if iBin == 1
        ...
        titleText = ['SFC: Ensemble Spiking vs Global LFP - Full Period'];
        fileNameText = ['cutoff_raw_SFC_Ensemble_Spiking_vs_Global_LFP_Full_Period.fig'];
        
    elseif iBin == 2
        
        titleText = ['SFC: Ensemble Spiking vs Global LFP. Pre: -1:-0.5. Post: 0:0.5'];
        fileNameText = ['cutoff_raw_SFC_Ensemble_Spiking_vs_Global_LFP_Pre_-1_-0.5_Post_0_0.5.fig'];
        
    elseif iBin == 3
        
        titleText = ['SFC: Ensemble Spiking vs Global LFP. Pre: -0.5:0. Post: 0.5:1'];
        fileNameText = ['cutoff_raw_SFC_Ensemble_Spiking_vs_Global_LFP_Pre_-0.5_0_Post_0.5_1.fig'];
        
    elseif iBin == 4
        
        titleText = ['SFC: Ensemble Spiking vs Global LFP. Pre: -1:-0.25 Post: 0.25:1'];
        fileNameText = ['cutoff_raw_SFC_Ensemble_Spiking_vs_Global_LFP_Pre_-1_0.25_Post_0.25_1.fig'];
